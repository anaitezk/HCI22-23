...
<section class="fill-form">
  <form action="/action_page.php">
    <h1>Προσωικά Στοιχεία</h1>
    <label for="fname">Ονοματεπώνυμο</label>
    <input type="text" id="flname" name="Onomateponymo" value = "<?php echo $_SESSION["name"] ?>" ><br>

    <label for="lname">Αριθμός Μητρώου</label>
    <input type="text" id="number" name="am" value = "<?php echo $_SESSION["recordnumber"] ?>"><br>
    ...
    <!-- <form> -->
        <label for="myfile">Αναλυτική Βαθμολογία (pdf):</label>
